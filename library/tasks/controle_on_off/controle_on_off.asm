...
;controle_on_off.c,89 :: 		if (SOFT_TIMER_delay_ms(&timer[T_ON_OFF], 1000))
...
;controle_on_off.c,101 :: 		PWM1_set_duty_cycle(100);
	MOVLW       100
...
;controle_on_off.c,103 :: 		else if (ON_OFF_level_meter > ON_OFF_setpoint)
	MOVF        _readBuffer+14, 0 
	MOVWF       R1 
	CLRF        R0 
	MOVF        R0, 0 
...
;controle_on_off.c,111 :: 		PWM2_set_duty_cycle(100);
	MOVLW       100
...
;controle_on_off.c,117 :: 		ON_OFF_fill_valve(0);
	CLRF        _writeBuffer+18 
	CLRF        _writeBuffer+19 
;controle_on_off.c,118 :: 		PWM1_set_duty_cycle(0);
	CLRF        FARG_PWM1_set_duty_cycle_duty_porcent+0 
	CALL        _PWM1_set_duty_cycle+0, 0
;controle_on_off.c,121 :: 		ON_OFF_discharge_valve(0);
	CLRF        _writeBuffer+20 
	CLRF        _writeBuffer+21 
;controle_on_off.c,122 :: 		PWM2_set_duty_cycle(0);
	CLRF        FARG_PWM2_set_duty_cycle_duty_porcent+0 
	CALL        _PWM2_set_duty_cycle+0, 0
;controle_on_off.c,123 :: 		}
L_CONTROLE_ON_OFF_main10:
;controle_on_off.c,124 :: 		}
L_CONTROLE_ON_OFF_main5:
;controle_on_off.c,125 :: 		} // end start
	GOTO        L_CONTROLE_ON_OFF_main11
L_CONTROLE_ON_OFF_main4:
;controle_on_off.c,127 :: 		stop();
	CALL        controle_on_off_stop+0, 0
L_CONTROLE_ON_OFF_main11:
;controle_on_off.c,128 :: 		}
