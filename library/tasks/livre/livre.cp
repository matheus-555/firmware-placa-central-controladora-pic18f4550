...
#line 39 "d:/area de trabalho/projeto sistema central de controle/firmware_pic18f4550/library/tasks/livre/../../framework/usb/usb.h"
void USB_init();
void USB_index_data();
...
#line 9 "d:/area de trabalho/projeto sistema central de controle/firmware_pic18f4550/library/tasks/livre/../../framework/pwm/pwm.h"
...
void LIVRE_main()
{
 ...
 PWM_set_duty_cycle( (( readBuffer[11]  << 8) | readBuffer[10] ) );
 }
