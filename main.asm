...
;main.c,31 :: 		}
L_main3:
;main.c,34 :: 		if (timer0.is_finalizado[TIMER0_3MS])
	MOVF        _timer0+2, 1 
	BTFSC       STATUS+0, 2 
	GOTO        L_main4
;main.c,36 :: 		USB_index_data();
	CALL        _USB_index_data+0, 0
;main.c,37 :: 		USB_SEND_DATA();
	...
	CALL        _HID_Write+0, 0
;main.c,38 :: 		ADC_read_all();
	CALL        _ADC_read_all+0, 0
;main.c,39 :: 		timer0.is_finalizado[TIMER0_3MS] = false;
	CLRF        _timer0+2 
;main.c,40 :: 		}
L_main4:
;main.c,41 :: 		}
...
;main.c,44 :: 		void system_init()
;main.c,47 :: 		ADC_init();
	CALL        _ADC_init+0, 0
;main.c,50 :: 		TRISC &= ~(1<<TRISC6);
	BCF         TRISC+0, 6 
;main.c,51 :: 		LATC  &= ~(1<<TRISC6);
	BCF         LATC+0, 6 
;main.c,55 :: 		GPIO_init();
	CALL        _GPIO_init+0, 0
