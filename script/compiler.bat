...
SET LIB_FRAMEWORK=-SP %LIBRARIES%\framework\timer0\ -SP %LIBRARIES%\framework\interrupt\ -SP %LIBRARIES%\framework\gpio\ -SP %LIBRARIES%\framework\usb\ -SP %LIBRARIES%\framework\pwm\ -SP %LIBRARIES%\framework\adc\ -SP %LIBRARIES%\framework\soft_timer\ -SP %LIBRARIES%\framework\math\
SET SRC_FRAMEWORK="timer0.c" "interrupt.c" "gpio.c" "USBdsc.c" "usb.c" "pwm.c" "adc.c" "soft_timer.c" "math.c"
