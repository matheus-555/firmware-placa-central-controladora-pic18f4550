...
SET LIB_TASKS=-SP %LIBRARIES%\tasks\ -SP %LIBRARIES%\tasks\blink_portd\ -SP %LIBRARIES%\tasks\livre\ -SP %LIBRARIES%\tasks\contagem_binaria\ -SP %LIBRARIES%\tasks\controle_pid\ -SP %LIBRARIES%\tasks\semaforo\ -SP %LIBRARIES%\tasks\painel_comando\
SET SRC_TASKS="tasks.c" "blink_portd.c" "livre.c" "contagem_binaria.c" "controle_pid.c" "semaforo.c" "painel_comando.c"
